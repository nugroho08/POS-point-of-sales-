...
class BayarController extends Controller
{
    public function index()
    {
        ...
        $idTransaksi = Transaksi::orderBy('id_transaksi', 'DESC')->first();
    ...
    public function store(Request $request)
    {
        ...
        $barang_harga=Barang::where('id_barang',$request->id_barang)->first();
    ...
    public function bayar(Request $request, $id)
    {
        ...
        $a = Transaksi::where('id_transaksi', $id)
        ->update([
