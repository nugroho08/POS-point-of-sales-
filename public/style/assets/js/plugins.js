...
!(function(t, e) {
    ...
    var o = (function(t) {
            ...
            return (
                (i = !window.QUnit && { end: "transitionend" }),
                ...
                u = (function() {
                    ...
                    return (
                        ...
                        (i._removeElement = function(e) {
                            var n = this;
                            t(e).removeClass(c),
                                o.supportsTransitionEnd() && t(e).hasClass(h)
                                    ? t(e)
        ...
        l = (function(t) {
                                ...
                                if (s) {
                                    ...
                                    if (e) {
                                        if (
                                            ...
                                            return;
                                        (s.checked = !t(this._element).hasClass(
                                            a
                                        )),
                                            t(s).trigger("change");
                                    }
            ...
            return (
                t(document)
                    .on(g.CLICK_DATA_API, c, function(e) {
                        e.preventDefault();
                        var n = e.target;
            ...
            var e = "carousel",
                ...
                I = (function() {
                    ...
                    return (
                        ...
                        (I.pause = function(e) {
                            e || (this._isPaused = !0),
                                t(this._element).find(C.NEXT_PREV)[0] &&
                        ...
                        (I._getConfig = function(t) {
                            return (
                                (t = r({}, l, t)), o.typeCheckConfig(e, t, h), t
                            );
                        }),
                        (I._addEventListeners = function() {
                            var e = this;
                            this._config.keyboard &&
                                t(this._element).on(_.KEYDOWN, function(t) {
                                    return e._keydown(t);
                                }),
                        ...
                        (I._triggerSlideEvent = function(e, n) {
                            var i = this._getItemIndex(e),
                                s = this._getItemIndex(
                                    t(this._element).find(C.ACTIVE_ITEM)[0]
                                ),
                                r = t.Event(_.SLIDE, {
                                    relatedTarget: e,
                                    direction: n,
        ...
        u = (function(t) {
            ...
            return (
                t(document)
                    ...
                    .on(
                        u.CLICK_DATA_API + " " + u.KEYUP_DATA_API,
                        L._clearMenus
                    )
                    .on(u.CLICK_DATA_API, T, function(e) {
                        e.preventDefault(),
                            e.stopPropagation(),
        ...
        f = (function(t) {
            var e = "modal",
                ...
                i = "." + n,
                a = t.fn.modal,
                l = { bacidrop: !0, keyboard: !0, focus: !0, show: !0 },
                h = {
                    bacidrop: "(boolean|string)",
                    keyboard: "boolean",
                    focus: "boolean",
                    show: "boolean"
                },
                    ...
                    return (
                                                ...
                                                t(n._element).one(
                                                    ...
                                                    function(e) {
                                                        t(e.target).is(
                                                            ...
                                                            (n._ignoreBacidropClick = !0);
                                                    }
                                                );
                                            }
                                        ),
                                        this._showBacidrop(function() {
                        ...
                        (p.dispose = function() {
                            t.removeData(this._element, n),
                                ...
                                (this._ignoreBacidropClick = null),
                        ...
                        (p._removeBacidrop = function() {
                            this._bacidrop &&
                                (t(this._bacidrop).remove(),
                                (this._bacidrop = null));
                        }),
                        (p._showBacidrop = function(e) {
                            var n = this,
                                i = t(this._element).hasClass(_) ? _ : "";
                            if (this._isShown && this._config.bacidrop) {
                                var s = o.supportsTransitionEnd() && i;
                                if (
                                    ((this._bacidrop = document.createElement(
                                        "div"
                                    )),
                                    (this._bacidrop.className = f),
                                    i && t(this._bacidrop).addClass(i),
                                    t(this._bacidrop).appendTo(document.body),
                                    t(this._element).on(
                                        c.CLICK_DISMISS,
                                        function(t) {
                                            n._ignoreBacidropClick
                                                ? (n._ignoreBacidropClick = !1)
                                                : t.target ===
                                                      t.currentTarget &&
                                                  ("static" ===
                                                  n._config.bacidrop
                                    ...
                                    s && o.reflow(this._bacidrop),
                                    t(this._bacidrop).addClass(g),
                                    !e)
                                )
                                    return;
                                if (!s) return void e();
                                t(this._bacidrop)
                                    ...
                                    .emulateTransitionEnd(150);
                            } else if (!this._isShown && this._bacidrop) {
                                t(this._bacidrop).removeClass(g);
                                var r = function() {
                                    n._removeBacidrop(), e && e();
                                };
                                o.supportsTransitionEnd() &&
                                t(this._element).hasClass(_)
                                    ? t(this._bacidrop)
                        ...
                        (p._resetScrollbar = function() {
                            t(m.FIXED_CONTENT).each(function(e, n) {
                                ...
                                t(
                                    m.STICKY_CONTENT + ", " + m.NAVBAR_TOGGLER
                                ).each(function(e, n) {
        ...
        g = (function(t) {
            ...
            return (
                t(window).on(c.LOAD_DATA_API, function() {
                    for (
                        var e = t.makeArray(t(d.DATA_SPY)), n = e.length;
                        n--;
        ...
        m = (function(t) {
                        ...
                        (i.show = function() {
                            ...
                            if (
                                ...
                                var u = t.Event(r.HIDE, {
                                    ...
                                    f = t.Event(r.SHOW, { relatedTarget: i });
                                if (
                                    (i && t(i).trigger(u),
                                    ...
                                    n
                                        ? this._activate(n, n.parentNode, m)
                                        : m();
                                }
                            }
                        }),
            ...
            return (
                t(document).on(r.CLICK_DATA_API, m, function(e) {
                    e.preventDefault(),
    ...
    var factory = function($) {
        ...
        Toggles.prototype.bindEvents = function() {
            ...
            if (
                self.opts["click"] &&
                (!self.opts["clicker"] ||
                    !self.opts["clicker"].has(self.el).length)
            ) {
