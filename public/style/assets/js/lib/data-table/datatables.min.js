        ...
        m.fn.extend({
            ...
            domManip: function(a, b) {
                ...
                if (
                    ...
                    for (
                        g = m.map(ua(i, "script"), xa), f = g.length;
                        l > j;
                        j++
                    )
                        (d = i),
        ...
        return (
            c ||
                ...
                ("none" !== c && c) ||
                    ...
                    (b = (Ca[0].contentWindow || Ca[0].contentDocument)
                        .document),
                    b.write(),
                    b.close(),
                    (c = Ea(a, b)),
            ...
            return h || "jsonp" === b.dataTypes[0]
                ? ((e = b.jsonpCallback = m.isFunction(b.jsonpCallback)
                  ...
                  d.always(function() {
                      (a[e] = f),
                          b[e] &&
                              ((b.jsonpCallback = c.jsonpCallback), _b.push(e)),
...
+(function(a) {
    ...
    +(function(a) {
        ...
        (c.VERSION = "3.3.5"),
            ...
            (c.BACidROP_TRANSITION_DURATION = 150),
            (c.DEFAULTS = { bacidrop: !0, keyboard: !0, show: !0 }),
                                ...
                                d.$element.one(
                                    ...
                                    function(b) {
                                        a(b.target).is(d.$element) &&
                                            (d.ignoreBacidropClick = !0);
                                    }
                                );
                            }
                        ),
                        this.bacidrop(function() {
                            var e =
                                a.support.transition &&
            ...
            (c.prototype.removeBacidrop = function() {
                this.$bacidrop && this.$bacidrop.remove(),
                    (this.$bacidrop = null);
            }),
            (c.prototype.bacidrop = function(b) {
                var d = this,
                    e = this.$element.hasClass("fade") ? "fade" : "";
                if (this.isShown && this.options.bacidrop) {
                    var f = a.support.transition && e;
                    if (
                        ((this.$bacidrop = a(document.createElement("div"))
                            .addClass("modal-bacidrop " + e)
                            .appendTo(this.$body)),
                        this.$element.on(
                            "click.dismiss.bs.modal",
                            a.proxy(function(a) {
                                return this.ignoreBacidropClick
                                    ? void (this.ignoreBacidropClick = !1)
                                    : void (
                                          a.target === a.currentTarget &&
                                          ("static" == this.options.bacidrop
                                              ? this.$element[0].focus()
                                              : this.hide())
                                      );
                            }, this)
                        ),
                        f && this.$bacidrop[0].offsetWidth,
                        this.$bacidrop.addClass("in"),
                        !b)
                    )
                        return;
                    f
                        ? this.$bacidrop
                              ...
                              .emulateTransitionEnd(
                                  c.BACidROP_TRANSITION_DURATION
                              )
                        : b();
                } else if (!this.isShown && this.$bacidrop) {
                    this.$bacidrop.removeClass("in");
                    var g = function() {
                        d.removeBacidrop(), b && b();
                    };
                    a.support.transition && this.$element.hasClass("fade")
                        ? this.$bacidrop
...
(function(Fa, T, k) {
    var S = function(g) {
        ...
        function ka(a, b, c) {
            ...
            b._bAttrSrc =
                g.isPlainObject(h) && (c(h.sort) || c(h.type) || c(h.filter));
            ...
            !b.bSortable || (!a && !c)
                ? ((b.sSortingClass = d.sSortableNone),
                  (b.sSortingClassJUI = ""))
                : a && !c
        ...
        function L(a, b, c, d) {
            ...
            for (var h = a.aoColumns, i = 0, j = h.length; i < j; i++)
                c && Ja(a, e, i, y(a, e, i)), (h[i].sType = null);
        ...
        function y(a, b, c, d) {
            var e = a.iDraw,
                ...
                h = a.aoData[b]._aData,
                i = f.sDefaultContent,
                c = f.fnGetData(h, d, { settings: a, row: b, col: c });
            if (c === k)
                return (
                    a.iDrawError != e &&
                        null === i &&
        ...
        function da(a, b, c, d) {
            ...
            if ("dom" === c || ((!c || "auto" === c) && "dom" === e.src))
                e._aData = na(a, e, d, d === k ? k : e._aData).data;
            else {
                var i = e.anCells;
                if (i)
                    if (d !== k) h(i[d], d);
        ...
        function Na(a, b) {
            ...
            if (c) {
                ...
                d.DT_RowClass &&
                    ...
                    (b.__rowc = b.__rowc ? Oa(b.__rowc.concat(e)) : e),
                    g(c)
        ...
        function nb(a) {
            ...
            for (
                var f = a.sDom.split(""), h, i, j, n, l, r, q = 0;
                q < f.length;
                q++
            ) {
                h = null;
        ...
        function ra(a, b, c) {
            ...
            a.fnServerData
                ...
                ? (a.jqXHR = g.ajax(g.extend(n, { url: h || a.sAjaxSource })))
                : g.isFunction(h)
                ? (a.jqXHR = h.call(i, b, j, a))
                : ((a.jqXHR = g.ajax(g.extend(n, h))), (h.data = f));
        }
        function lb(a) {
        ...
        function ub(a) {
            ...
            for (h = 0; h < c; h++)
                (n = b[h]),
                    ...
                    q("mDataProp_" + h, j),
                    d.bFilter &&
                        (q("sSearch_" + h, l.sSearch),
                        q("bRegex_" + h, l.bRegex),
                        q("bSearchable_" + h, n.bSearchable)),
        ...
        function sa(a, b) {
            var c =
                g.isPlainObject(a.ajax) && a.ajax.dataSrc !== k
                    ? a.ajax.dataSrc
                    : a.sAjaxDataProp;
        ...
        function xb(a, b, c, d, e, f) {
            if ("" !== b)
                for (
                    var h = a.aiDisplay, d = Ra(b, d, e, f), e = h.length - 1;
                    0 <= e;
                    e--
                )
                    (b = a.aoData[h[e]]._aFilterData[c]),
                    ...
                    for (h = b.length; e < h; e++)
                        (c = b[e]),
                            ...
                            j.indexOf &&
                                -1 !== j.indexOf("&") &&
                                ((wa.innerHTML = j),
                                (j = $b ? wa.textContent : wa.innerText)),
        ...
        function sb(a) {
            ...
            c ||
                ...
                g(a.nTable).attr("aria-describedby", b + "_info"));
            return d[0];
        }
        function Cb(a) {
        ...
        function Db(a, b) {
            ...
            return b
                ...
                .replace(/_PAGE_/g, c.call(a, h ? 1 : Math.ceil(d / e)))
                .replace(/_PAGES_/g, c.call(a, h ? 1 : Math.ceil(f / e)));
        }
        function ha(a) {
            var b,
                c,
        ...
        function rb(a) {
            ...
            l.length || (l = null);
            j = g("<div/>", { class: f.sScrollWrapper })
                .append(
                    g("<div/>", { class: f.sScrollHead })
                        .css({
                            overflow: "hidden",
                            position: "relative",
                            border: 0,
                        ...
                        .append(
                            g("<div/>", { class: f.sScrollHeadInner })
                                .css({
            ...
            l &&
                j.append(
                    g("<div/>", { class: f.sScrollFoot })
                        ...
                        .append(
                            g("<div/>", { class: f.sScrollFootInner }).append(
                                n
                                    .removeAttr("id")
                                    .css("margin-left", 0)
        ...
        function Z(a) {
            ...
            if (E.outerWidth() < f) {
                ...
                if (
                    ...
                    t.width = u(s - b);
                ("" === c || "" !== d) &&
                    J(a, 1, "Possible column misalignment", 6);
            } else s = "100%";
            k.width = u(s);
            h.width = u(s);
        ...
        function H(a, b, c) {
            for (var d = 0, e = 0, f = b.length, h, i; e < f; ) {
                ...
                for (i = c ? c[e].firstChild : null; h; )
                    1 === h.nodeType && (c ? a(h, i, d) : a(h, d), d++),
                        (h = h.nextSibling),
        ...
        function Ha(a) {
            ...
            for (m = 0; m < j.length; m++)
                (o = c[j[m]]),
                    null !== o.sWidth &&
                        ((o.sWidth = Fb(o.sWidthOrig, k)), (q = !0));
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    (h = f[b]),
                        (i = e[h].sType || "string"),
                        n[a]._idx === k &&
                            (n[a]._idx = g.inArray(n[a][1], e[h].asSorting)),
                        d.push({
                            src: j,
                            col: h,
                            dir: n[a][1],
        ...
        function mb(a) {
            ...
            for (c = n.length; b < c; b++)
                (i = n[b]), i.formatter && h++, Jb(a, i.col);
        ...
        function xa(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++)
                    (h = b[e].src),
                        g(D(a.aoData, "anCells", h)).removeClass(
                            c + (2 > e ? e + 1 : 3)
                        );
                e = 0;
                for (f = d.length; e < f; e++)
                    (h = d[e].src),
                        g(D(a.aoData, "anCells", h)).addClass(
                            c + (2 > e ? e + 1 : 3)
                        );
            }
            a.aLastSort = d;
        ...
        function Jb(a, b) {
            ...
            for (
                var f,
                    h = m.ext.type.order[c.sType + "-pre"],
                    i = 0,
                    g = a.aoData.length;
                i < g;
                i++
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (
                    ...
                    for (c = e.columns.length; b < c; b++) {
                        ...
                        f.search !== k &&
                            g.extend(a.aoPreSearchCols[b], Bb(f.search));
                    }
        ...
        function w(a, b, c, d) {
            var e = [];
            b &&
                (e = g.map(a[b].slice().reverse(), function(b) {
                    return b.fn.apply(a.oInstance, d);
                }));
            null !== c &&
                ((b = g.Event(c + ".dt")),
                g(a.nTable).trigger(b, d),
                e.push(b.result));
            return e;
        }
        function Ta(a) {
        ...
        m = function(a) {
            ...
            this.fnAddData = function(a, b) {
                var c = this.api(!0),
                    d =
                        g.isArray(a) &&
                        (g.isArray(a[0]) || g.isPlainObject(a[0]))
                            ? c.rows.add(a)
                            : c.row.add(a);
                (b === k || b) && c.draw();
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    f.aLengthMenu &&
                        !f.iDisplayLength &&
                        (f.iDisplayLength = g.isArray(f.aLengthMenu[0])
                            ? f.aLengthMenu[0][0]
                            : f.aLengthMenu[0]);
                    f = Mb(g.extend(!0, {}, l), f);
                    F(
                    ...
                    A(o, "aoFooterCallback", f.fnFooterCallback, "user");
                    A(o, "aoInitComplete", f.fnInitComplete, "user");
                    A(o, "aoPreDrawCallback", f.fnPreDrawCallback, "user");
                    o.rowIdFn = P(f.rowId);
                    j = o.oClasses;
                    f.bJQueryUI
                        ? (g.extend(j, m.ext.oJUIClasses, f.oClasses),
                          f.sDom === l.sDom &&
                              "lfrtip" === l.sDom &&
                              (o.sDom = '<"H"lfr>t<"F"ip>'),
                          o.renderer)
                            ? g.isPlainObject(o.renderer) &&
                              !o.renderer.header &&
                              (o.renderer.header = "jqueryui")
                            : (o.renderer = "jqueryui")
                        : g.extend(j, m.ext.classes, f.oClasses);
                    r.addClass(j.sTable);
                    if ("" !== o.oScroll.sX || "" !== o.oScroll.sY)
                        o.oScroll.iBarWidth = Ib();
                    o.iInitDisplayStart === k &&
                        ((o.iInitDisplayStart = f.iDisplayStart),
                        (o._iDisplayStart = f.iDisplayStart));
                    null !== f.iDeferLoading &&
                        ((o.bDeferLoading = !0),
                        (e = g.isArray(f.iDeferLoading)),
                    ...
                    -1 !==
                        ...
                        (g("tbody tr", this).removeClass(e.join(" ")),
                    ...
                    ib(o, f.aoColumnDefs, p, function(a, b) {
                        ka(o, a, b);
                    });
                    if (s.length) {
                        var u = function(a, b) {
                    ...
                    f.bStateSave &&
                        ((v.bStateSave = !0),
                        Lb(o, f),
                        A(o, "aoDrawCallback", ya, "state_save"));
                    if (f.aaSorting === k) {
                        q = o.aaSorting;
                        e = 0;
                        for (i = q.length; e < i; e++)
                            q[e][1] = o.aoColumns[e].asSorting[0];
                    }
                    xa(o);
                    v.bSort &&
                    ...
                    A(
                        ...
                        "aoDrawCallback",
                        function() {
                            (o.bSorted || z(o) === "ssp" || v.bDeferRender) &&
                                xa(o);
                        },
                        "sc"
                    );
                    ...
                    0 === i.length || 0 === i.children().length
                        ...
                        : 0 < i.length &&
                          ((o.nTFoot = i[0]), ea(o.aoFooter, o.nTFoot));
                    if (f.aaData)
                        for (e = 0; e < f.aaData.length; e++) L(o, f.aaData[e]);
                    else
                        (o.bDeferLoading || "dom" == z(o)) &&
                            ma(o, g(o.nTBody).children("tr"));
        ...
        t.prototype = {
            ...
            iterator: function(a, b, c, d) {
                ...
                for (g = l.length; h < g; h++) {
                    var o = new t(l[h]);
                    if ("table" === b)
                        (f = c.call(o, l[h], h)), f !== k && e.push(f);
                    else if ("columns" === b || "rows" === b)
                        (f = c.call(o, l[h], this[h], h)), f !== k && e.push(f);
                    else if (
                        "column" === b ||
                        "column-rows" === b ||
                        "row" === b ||
                        ...
                        for (n = q.length; j < n; j++)
                            (f = q[j]),
                                (f =
                                    "cell" === b
                                        ? c.call(o, l[h], f.row, f.column, h, j)
                                        : c.call(o, l[h], f, h, j, m)),
                                f !== k && e.push(f);
                    }
                }
                return e.length || d
        ...
        t.register = p = function(a, b) {
            if (g.isArray(a))
                ...
                for (
                    var e = a.split("."), f = Ub, h, i, c = 0, d = e.length;
                    c < d;
                    c++
                ) {
                    h = (i = -1 !== e[c].indexOf("()"))
                    ...
                    j ||
                        ((j = { name: h, val: {}, methodExt: [], propExt: [] }),
                        f.push(j));
                    c === d - 1
                        ? (j.val = b)
                        : (f = i ? j.methodExt : j.propExt);
                }
        };
        ...
        var $a = function(a, b, c, d, e) {
                ...
                for (n = b.length; j < n; j++) {
                    ...
                    for (m = i.length; l < m; l++)
                        (h = c(
                            "string" === typeof i[l] ? g.trim(i[l]) : i[l]
                        )) &&
                            h.length &&
                            f.push.apply(f, h);
                }
                ...
                if (c.length && a.length) {
                    ...
                    if (d._details) {
                        ...
                        0 < D(g, "_details").length &&
                            ...
                            f.on("column-visibility.dt.DT_details", function(
                                a,
                                b
                            ) {
                                if (e === b)
                                    for (
                                        var c, d = ba(b), f = 0, k = g.length;
                                        f < k;
                                        f++
                                    )
                                        (c = g[f]),
                            ...
                            function(a) {
                                ...
                                if (typeof a === "function") {
                                    ...
                                    return g.map(h, function(b, f) {
                                        return a(f, Xb(c, f, 0, 0, e), j[f])
                                            ? f
                                            : null;
                                    });
                                }
                                var k =
                                    typeof a === "string" ? a.match(ec) : "";
                                if (k)
                                    switch (k[2]) {
                                        case "visIdx":
                                        case "visible":
        ...
        s("columns().visible()", "column().visible()", function(a, b) {
            return this.iterator("column", function(c, d) {
                ...
                if (a !== k && f.bVisible !== a) {
                    ...
                    fa(c, c.aoFooter);
                    if (b === k || b)
                        Y(c), (c.oScroll.sX || c.oScroll.sY) && Z(c);
        ...
        var Ba = function(a, b, c, d) {
            ...
            b && (a = Rb(a, b));
            a.replace &&
                (c && (a = a.replace(c, "")), d && (a = a.replace(d, "")));
            return 1 * a;
        };
                ...
                return {
                    display: function(f) {
                        ...
                        return (
                            g +
                            (d || "") +
                            i.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) +
                            f +
                            (e || "")
                        );
                    }
...
(function(l, q) {
                    ...
                    var k,
                        ...
                        l = function(a) {
                            ...
                            b(a.currentTarget).hasClass("disabled") ||
                                t.page(a.data.action).draw("page");
                        };
                    k = 0;
    ...
    "function" === typeof define && define.amd
        ...
        : jQuery && d(jQuery, jQuery.fn.dataTable);
})(window, document);
